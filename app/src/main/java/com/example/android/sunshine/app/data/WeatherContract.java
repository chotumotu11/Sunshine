...
public class WeatherContract {
    ...
    /**
     * The content authority is the name fot the entire content provider, similar to the relationship between domain name and its
     * website.A convenient String to use for the content authority is the package name for the app, which is guaranteed to be unique
     * on the device.
     */
    ...
    //Possible paths append to the base of the uri for possible uri
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        //Location setting string will be sent to openweathermap as the location setting.
        public static final String COLUMN_LOCATION_SETTING="location_setting";

        //Human readable location String provided by the api, because the string "Kolkata" is more recognizable than 700106
        public static final String COLUMN_CITY_NAME="city_name";

        //In order to uniquely pin point the location on the map intent.
